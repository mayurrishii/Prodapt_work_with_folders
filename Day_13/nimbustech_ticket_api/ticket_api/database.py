"""
Database setup for the NimbusTech Ticket API.
...
# SQLite database file, stored next to the `app` folder as `tickets.db`.
...
# Base is the parent class that all our ORM models (see db_models.py)
# inherit from. SQLAlchemy uses it to keep track of every table we define.
